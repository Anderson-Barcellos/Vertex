/**
 * Vertex V2 - Abdominal Vessels Exam (MODERN DESIGN)
...
function AbdominalVesselsExamModern() {
  ...
  // Handlers para persistência de estado temporário
  const handleTempDetailsChange = (organId: string, details: any) => {
              ...
              onError: async (error) => {
                ...
                try {
                  const fallback = await generateReport(
                    ...
                    { organsList: abdominalVesselsOrgans, provider }
                  );
                  ...
                  setAiGenerationStats({
                    ...
                    inputChars: promptText.length,
                    outputChars,
                    errorMessage: (fallbackErr as Error)?.message || 'Erro no fallback'
                  });
                }
              }
            }
  ...
  const currentOrgan = abdominalVesselsOrgans.find(organ => organ.id === selectedOrgan);
        ...
        header={(
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">Ecodoppler de Vasos Abdominais</h1>
                <p className="text-xs text-gray-400">Aorta, mesentéricas e renais</p>
              </div>
            </div>
          </div>
        )}
...
export default AbdominalVesselsExamModern;
